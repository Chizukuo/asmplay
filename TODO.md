...
#### 已完成 ✅
- [x] 支持字符串指令
  - [x] MOVSB/MOVSW - 字符串传送 (字节/字)
  - [x] CMPSB/CMPSW - 字符串比较 (字节/字)
  - [x] SCASB/SCASW - 字符串扫描 (字节/字)
  - [x] LODSB/LODSW - 加载字符串 (字节/字)
  - [x] STOSB/STOSW - 存储字符串 (字节/字)
  - [x] REP/REPE/REPNE - 重复前缀
...
当前最需要的贡献：
1. 🔥 更多移位和乘除法指令 (RCL/RCR, IMUL/IDIV)
2. 🔥 宏汇编支持 (MACRO/EQU)
3. 🔥 更多示例程序
4. 🔥 移动端优化
5. 🔥 英文文档
